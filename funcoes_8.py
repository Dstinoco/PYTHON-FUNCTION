...
estoque_jan_a_abri = estoque_fim_jan + estoque_fim_fev + estoque_fim_mar + estoque_fim_abr 
print(lista_produtos(estoque_jan_a_abri))
print(len(lista_produtos(estoque_jan_a_abri)))        
